...
class FollowersAdapter(private val list: MutableList<User>, val context: Context, val application: Application, val fragmentManager: FragmentManager): RecyclerView.Adapter<FollowersAdapter.ViewHolder>() {
